...
const Button = () => {
  ...
  return (
    <button
      ...
      className="w-16 h-8 flex items-center bg-gray-300 dark:bg-gray-300 rounded-full p-1 transition-all duration-300 fixed ml-96 max-lg:ml-36 max-lg:static max-md:static "
    >
      <div
...
export const Header = () => {
  ...
  <div className="max-md:mr-[140px] ">
    <Button />
      ...
      <div className=" w-[700px] max-md:w-[550px] max-xs:w-[250px]">
      ...
      <div className="relative max-w-2xl mb-48 " id="projets">
