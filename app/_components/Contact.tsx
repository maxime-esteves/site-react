...
export const Contact = () => {
  ...
  return(
      <><div className=" flex mt-48 mb-8 gap-10  max-md:flex-col-reverse max-md:items-center max-md:mt-8" id="contact">
<div className="">


      <h1 className="text-5xl font-bold text-white mb-8 dark:text-black "> Contact</h1>

        <p className="text-base text-white mb-24 w-[700px] max-md:w-[550px] max-xs:w-[250px] dark:text-black "> 💪 Ma <strong className="text-red-500">curiosité </strong>  
      ...
      <div className=" rounded-3xl flex items-center justify-start gap-8 ">
      ...
      <a href=""><Image width={200} height={50} className="w-64 h-64 mr-24 rounded-full max-lg:w-[150px] max-lg:h-[150px] max-lg:mt-24 max-md:mr-0" src="/photoProfil.png" alt="" /></a>
      </div></>
